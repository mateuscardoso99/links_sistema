...
export const COOKIE_ACCOUNT = 'acc' //nome do cookie
export const COOKIE_TOKEN = 'tk'
export const COOKIE_REFRESH_TOKEN = 'rtk'

export const setAccount = (account) => setCookie(COOKIE_ACCOUNT, account, options)//CRIANDO COOKIE PRO USUARIO LOGADO
